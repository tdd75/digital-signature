package com.hust.application.controller;



import com.hust.hash.Hash;
import com.hust.hash.impl.SHA1;
import com.hust.hash.impl.SHA256;
import javafx.event.ActionEvent;
import javafx.fxml.FXML;
import javafx.scene.control.*;
import javafx.scene.input.KeyEvent;
import javafx.stage.FileChooser;
import com.hust.digitalSignature.DigitalSignatureMath;
import com.hust.digitalSignature.rsa.RSAPublicKey;
import com.hust.digitalSignature.rsa.RSASignature;
...
public class Controller {
    ...
    private Map<String, Hash> cryptoHashAlgorythms;
    ...
    void btnSignClick(ActionEvent event) {
        try {
            ...
            Hash cryptoHash = cryptoHashAlgorythms.get(hashAlgorythm);
