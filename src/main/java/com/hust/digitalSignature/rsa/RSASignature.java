package com.hust.digitalSignature.rsa;

import com.hust.hash.Hash;
import com.hust.digitalSignature.DigitalSignatureMath;
import com.hust.digitalSignature.SignatureAlgorithm;
...
public class RSASignature implements SignatureAlgorithm {
     ...
     */
    public RSASignature(BigInteger p, BigInteger q, BigInteger privateexp, Hash hashFunction) {
     ...
     */
    public static boolean checkSignature(RSAPublicKey key, BigInteger s, byte[] message, Hash hashFunction) {
